...
namespace Boa.Runtime
{
  ...
  { public void clear() { Clear(); }
    ...
    public object __delitem__(object key) { Remove(key); }
    public object __getitem__(object key)
    { if(Contains(key)) return this[key];
      else throw Ops.KeyError(Ops.Repr(key));
    }
    public object __setitem__(object key, object value) { data[key]=value; }
    public int __len__() { return Count; }
    public bool __contains__(object key) { return Contains(value); }
    #endregion
  }
